...
function create (env, ctx) {
  ...
  //const kitescout = require('./clocks.js')(env, ctx)
  app.use('/ks',ks);// require('../../KiteScout/server/index.js')(env, ctx)) //add kitescout express app... 

  // app.use('/ks', (req, res) => {
  //   res.redirect('../../KiteScout/server');
  //  });// require('../../KiteScout/server/index.js')(env, ctx)) //add kitescout express app... 
