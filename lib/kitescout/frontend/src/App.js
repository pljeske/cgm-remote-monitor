...
function App() {
  ...
  const getSettings = async () => {
    ...
    settings.current.bgTargTop = settings.current.bgTargTop ? settings.current.bgTargTop / unitConverter.current : 180 / settings.current.bgTargTop;
    settings.current.bgTargBot = settings.current.bgTargBot ? settings.current.bgTargBot / unitConverter.current : 80 / settings.current.bgTargBot;
  }
        ...
        <table className="infoTable" >
          <tbody>
            ...
            <tr>
              ...
              }} className="panBtn" data-tip={'Pan to current time'}>{'pan >>'}</button></td>
            </tr>
          </tbody>
        </table>
