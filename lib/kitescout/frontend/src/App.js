      ...
      <div className="info" style={{ maxHeight: "30vh" }}>
        ...
        <table className="infoTable" >
          <tbody>
            <tr>
              <td rowspan="3" >
                <span style={currInfo?.bg > settings.current.bgTargBot && currInfo?.bg < settings.current.bgTargTop ? { color: RGB_green, fontSize: "10vmin" } : { color: RGB_red, fontSize: "10vmin" }}>
